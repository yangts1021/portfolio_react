    ...
    <div className='animate-fade-in space-y-6'>
      <div className='grid grid-cols-1 md:grid-cols-2 gap-4'>
        ...
        <div className='bg-white dark:bg-gray-900 p-5 rounded-xl shadow-sm border border-gray-100 dark:border-gray-800 text-center transition-colors'>
          ...
          <div
            className={`text-3xl font-bold ${overallRatio < 140 ? 'text-red-600' : overallRatio < 166 ? 'text-yellow-600' : 'text-green-600'} dark:opacity-90`}
          >
        ...
        <div className='lg:col-span-1'>
          <div className='bg-white dark:bg-gray-900 p-6 rounded-xl shadow-sm border border-gray-100 dark:border-gray-800 transition-colors'>
            <h2 className='text-lg font-bold mb-4 flex items-center dark:text-white'>
              <i className='fa-solid fa-hand-holding-dollar text-blue-500 mr-2'></i> 新增質借
            </h2>
            <form onSubmit={handleSubmit} className='space-y-4'>
              <div className='grid grid-cols-2 gap-4'>
                <div>
                  ...
                  <input
                    ...
                    className='w-full bg-gray-50 dark:bg-gray-800 border border-gray-300 dark:border-gray-700 rounded p-2 text-xs dark:text-white'
                  />
                </div>
                <div>
                  <label className='block text-[10px] font-medium text-gray-500 dark:text-gray-400'>
              ...
              <div className='grid grid-cols-2 gap-4'>
                <div>
                  ...
                  <input
                    ...
                    placeholder='2330'
                    className='w-full bg-gray-50 dark:bg-gray-800 border border-gray-300 dark:border-gray-700 rounded p-2 text-xs uppercase dark:text-white'
                  />
                </div>
                <div>
                  <label className='block text-[10px] font-medium text-gray-500 dark:text-gray-400'>
              ...
              <button
                disabled={loading}
                className='w-full bg-blue-600 text-white rounded p-3 text-sm font-bold hover:bg-blue-700 transition-colors'
              >
                ...
                {pledgeData.map((p, i) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <td className='px-4 py-4 text-center dark:text-gray-300'>
                        {p.repaymentDate}
                      </td>
                    </tr>
                  );
